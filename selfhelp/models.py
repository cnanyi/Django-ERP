...
class WorkOrder(generic.BO):
    ...
    refer = models.ForeignKey("self",on_delete=models.DO_NOTHING, verbose_name=_("refer wo"),blank=True,null=True)
    ...
    service = models.ForeignKey(Material,on_delete=models.DO_NOTHING, verbose_name=_("service name"),null=True,blank=True,limit_choices_to={"is_virtual":"1"})
    project = models.ForeignKey(Project,on_delete=models.DO_NOTHING, verbose_name=_("project"),null=True,blank=True)
...
class WOExtraValue(models.Model):
    ...
    """
    workorder = models.ForeignKey(WorkOrder,on_delete=models.DO_NOTHING, verbose_name=_("workorder"))
    param_name = models.ForeignKey(ExtraParam,on_delete=models.DO_NOTHING, verbose_name=_("extra param"))
...
class WOItem(models.Model):
    ...
    """
    workorder = models.ForeignKey(WorkOrder,on_delete=models.DO_NOTHING, verbose_name=_("workorder"))
    material = models.ForeignKey(Material,on_delete=models.DO_NOTHING, verbose_name=_("material"),null=True,blank=True,limit_choices_to={"is_virtual":"0"})
...
class Reimbursement(generic.BO):
    ...
    description = models.TextField(_("description"),blank=True,null=True)
    project = models.ForeignKey(Project,on_delete=models.DO_NOTHING, verbose_name=_("project"))
    wo = models.ForeignKey(WorkOrder,on_delete=models.DO_NOTHING, verbose_name=_("work order"),null=True,blank=True)
    user = models.ForeignKey(User,on_delete=models.DO_NOTHING, verbose_name=_("user"),blank=True,null=True)
    org = models.ForeignKey(OrgUnit,on_delete=models.DO_NOTHING, verbose_name=_("cost center"),blank=True,null=True)
    ...
    loan = models.ForeignKey(Loan,on_delete=models.DO_NOTHING, verbose_name=_("loan record"),blank=True,null=True)
    loan_amount = models.DecimalField(_("loan amount"),max_digits=10,decimal_places=2,blank=True,null=True)
    logout_amount = models.DecimalField(_("logout amount"),max_digits=10,decimal_places=2,blank=True,null=True)
...
class ReimbursementItem(models.Model):
    ...
    """
    import datetime
    reimbursement = models.ForeignKey(Reimbursement,on_delete=models.DO_NOTHING, verbose_name=_("reimbursement"))
    expense_account = models.ForeignKey(ExpenseAccount,on_delete=models.DO_NOTHING, verbose_name=_("expenses account"))
...
class Activity(generic.BO):
    ...
    title = models.CharField(_("title"),max_length=const.DB_CHAR_NAME_120)
    parent = models.ForeignKey('self',on_delete=models.DO_NOTHING, verbose_name=_("parent"),blank=True,null=True)
    description = models.TextField(_("description"),blank=True,null=True)
    ...
    room = models.ForeignKey(Material,on_delete=models.DO_NOTHING, verbose_name=_("room"),blank=True,null=True,limit_choices_to={'tp':20})
