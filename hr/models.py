...
class Entry(generic.BO):
    ...
    guider = models.ForeignKey(Employee,on_delete=models.DO_NOTHING, verbose_name=_("guider"))
    position = models.ForeignKey(Position,on_delete=models.DO_NOTHING, verbose_name = _('designate position'))
...
class EmployeeSalaryItem(models.Model):
    ...
    """
    entry = models.ForeignKey(Entry,on_delete=models.DO_NOTHING, verbose_name=_("employee entry"))
    employee = models.ForeignKey(Employee,on_delete=models.DO_NOTHING, verbose_name=_("employee"),blank=True,null=True)
    salary_item = models.ForeignKey(SalaryItem,on_delete=models.DO_NOTHING, verbose_name=_("salary item"))
