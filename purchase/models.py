...
class PurchaseOrder(generic.BO):
    ...
    partner = models.ForeignKey(Partner,on_delete=models.DO_NOTHING, verbose_name=_("partner"),limit_choices_to={"partner_type":"S"})
...
class POItem(models.Model):
    ...
    """
    index_weight = 2
    po = models.ForeignKey(PurchaseOrder,on_delete=models.DO_NOTHING, verbose_name=_("purchase order"))
    material = models.ForeignKey(Material,on_delete=models.DO_NOTHING, verbose_name=_("material"),limit_choices_to={"is_virtual":"0"})
    ...
    woitem = models.ForeignKey(WOItem,on_delete=models.DO_NOTHING, verbose_name=_("wo item"),blank=True,null=True)
