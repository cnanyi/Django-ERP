...
class Modal(models.Model):
    ...
    content_type = models.ForeignKey(ContentType,on_delete=models.DO_NOTHING, verbose_name=_("content type"),limit_choices_to={"app_label__in":['basedata','organ']})
...
class Node(models.Model):
    ...
    index_weight = 2
    modal = models.ForeignKey(Modal,on_delete=models.DO_NOTHING, verbose_name=_("workflow model"))
...
class Instance(models.Model):
    ...
    starter = models.ForeignKey(User,on_delete=models.DO_NOTHING, verbose_name=_("start user"),related_name="starter")
...
class History(models.Model):
    ...
    index_weight = 5
    inst = models.ForeignKey(Instance,on_delete=models.DO_NOTHING, verbose_name=_("workflow instance"))
    node = models.ForeignKey(Node,on_delete=models.DO_NOTHING, verbose_name=_("workflow node"),blank=True,null=True)
    user = models.ForeignKey(User,on_delete=models.DO_NOTHING, verbose_name=_("submitter"))
...
class TodoList(models.Model):
    ...
    inst = models.ForeignKey(Instance,on_delete=models.DO_NOTHING, verbose_name=_("workflow instance"))
    node = models.ForeignKey(Node,on_delete=models.DO_NOTHING, verbose_name=_("current node"),blank=True,null=True)
    app_name = models.CharField(_("app name"),max_length=const.DB_CHAR_NAME_60,blank=True,null=True)
    model_name = models.CharField(_("model name"),max_length=const.DB_CHAR_NAME_60,blank=True,null=True)
    user = models.ForeignKey(User,on_delete=models.DO_NOTHING, verbose_name=_("handler"))
