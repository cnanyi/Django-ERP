...
class Inventory(generic.BO):
    ...
    warehouse = models.ForeignKey(Warehouse,on_delete=models.DO_NOTHING, verbose_name=_("warehouse"))
    material = models.ForeignKey(Material,on_delete=models.DO_NOTHING, verbose_name=_("material"))
    measure = models.ForeignKey(Measure,on_delete=models.DO_NOTHING, verbose_name=_("measure"))
...
class InitialInventory(generic.BO):
    ...
    user = models.ForeignKey(User,on_delete=models.DO_NOTHING, verbose_name=_("user"),blank=True,null=True)
...
class StockIn(generic.BO):
    ...
    status = models.CharField(_("status"),max_length=const.DB_CHAR_CODE_2,default='0',choices=STATUS)
    execute_time = models.DateTimeField(_("execute time"),blank=True,null=True)
    po = models.ForeignKey(PurchaseOrder,on_delete=models.DO_NOTHING, verbose_name=_("purchase order"),null=True,limit_choices_to={"entry_status":"0"},blank=True)
...
class StockOut(generic.BO):
    ...
    org = models.ForeignKey(Organization,on_delete=models.DO_NOTHING, verbose_name=_("organization"),blank=True,null=True)
    title = models.CharField(_("title"),max_length=const.DB_CHAR_NAME_40)
    project = models.ForeignKey(Project,on_delete=models.DO_NOTHING, verbose_name=_("project"),blank=True,null=True)
    wo = models.ForeignKey(WorkOrder,on_delete=models.DO_NOTHING, verbose_name=_("work order"),blank=True,null=True)
    description = models.TextField(_("description"),blank=True,null=True)
    amount = models.DecimalField(_("money of amount"),max_digits=14,decimal_places=4,blank=True,null=True)
    user = models.ForeignKey(User,on_delete=models.DO_NOTHING, verbose_name=_("out user"),blank=True,null=True)
    status = models.CharField(_("status"),max_length=const.DB_CHAR_CODE_2,default='0',choices=STATUS)
    execute_time = models.DateTimeField(_("execute time"),blank=True,null=True)
...
class WareReturn(generic.BO):
    ...
    org = models.ForeignKey(Organization,on_delete=models.DO_NOTHING, verbose_name=_("organization"),blank=True,null=True)
    title = models.CharField(_("title"),max_length=const.DB_CHAR_NAME_40)
    out = models.ForeignKey(StockOut,on_delete=models.DO_NOTHING, verbose_name=_('StockOut'))
    amount = models.DecimalField(_("money of amount"),max_digits=14,decimal_places=4,blank=True,null=True)
    user = models.ForeignKey(User,on_delete=models.DO_NOTHING, verbose_name=_("out user"),blank=True,null=True)
    status = models.CharField(_("status"),max_length=const.DB_CHAR_CODE_2,default='0',choices=STATUS)
    execute_time = models.DateTimeField(_("execute time"),blank=True,null=True)
...
class InOutDetail(models.Model):
    ...
    warehouse = models.ForeignKey(Warehouse,on_delete=models.DO_NOTHING, verbose_name=_("warehouse"),blank=True,null=True)
    material = models.ForeignKey(Material,on_delete=models.DO_NOTHING, verbose_name=_("material"),limit_choices_to={"is_virtual":"0"},blank=True,null=True)
    measure = models.ForeignKey(Measure,on_delete=models.DO_NOTHING, verbose_name=_("measure"),blank=True,null=True)
...
class InitItem(InOutDetail):
    ...
    期初入库明细
    """
    master = models.ForeignKey(InitialInventory,on_delete=models.DO_NOTHING, )
...
class InItem(InOutDetail):
    ...
    入库单明细
    """
    master = models.ForeignKey(StockIn,on_delete=models.DO_NOTHING, )
    po_item = models.ForeignKey(POItem,on_delete=models.DO_NOTHING, verbose_name=_("po item"),blank=True,null=True)
...
class OutItem(InOutDetail):
    ...
    出库单明细
    """
    master = models.ForeignKey(StockOut,on_delete=models.DO_NOTHING, )
    inventory = models.ForeignKey(Inventory,on_delete=models.DO_NOTHING, blank=True,null=True,verbose_name=_("inventory material"))
...
class ReturnItem(InOutDetail):
    ...
    返库单明细
    """
    master = models.ForeignKey(WareReturn,on_delete=models.DO_NOTHING, )
    out_item = models.ForeignKey(OutItem,on_delete=models.DO_NOTHING, blank=True,null=True,verbose_name=_('out item'))
...
class AdjustItem(InOutDetail):
    ...
    库存调整明细
    """
    master = models.ForeignKey(WareAdjust,on_delete=models.DO_NOTHING, )
    inventory = models.ForeignKey(Inventory,on_delete=models.DO_NOTHING, blank=True,null=True,verbose_name=_("inventory material"))
